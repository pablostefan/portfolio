...
class AnimatedLineThroughText extends StatefulWidget {
  ...
  @override
  State<AnimatedLineThroughText> createState() => _AnimatedLineThroughTextState();
}

class _AnimatedLineThroughTextState extends State<AnimatedLineThroughText> with TickerProviderStateMixin {
        ...
        child: SlideTransition(
          ...
          child: Stack(
            children: [
              ...
              Visibility(
                visible: !widget.hasSlideBoxAnimation,
                child: Text(
                  widget.text,
                  style: _isHovering
                      ? hoverTextStyle?.copyWith(
