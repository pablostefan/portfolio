...
class AnimatedSlideBox extends AnimatedWidget {
  ...
  Animation<double> get invisibleAnimation => Tween<double>(begin: 0, end: width).animate(
        CurvedAnimation(
          parent: controller,
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          Visibility(
            visible: !visibleAnimation.isCompleted,
            child: Positioned(
              top: hiddenFactor,
              left: hiddenFactor,
              child: Container(
          ...
          Visibility(
            visible: !invisibleAnimation.isCompleted,
            child: Positioned(
              top: 0,
              child: Container(
